...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private final String RENDER_TYPE_CUTOUT = "cutout";
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlockWithRenderType(((DoorBlock) ModBlocks.SAPPHIRE_DOOR.get()), modLoc("block/sapphire_door_bottom"), modLoc("block/sapphire_door_top"), RENDER_TYPE_CUTOUT);
        trapdoorBlockWithRenderType(((TrapDoorBlock) ModBlocks.SAPPHIRE_TRAPDOOR.get()), modLoc("block/sapphire_trapdoor"), true, RENDER_TYPE_CUTOUT);
